...
<div class="page-head">
  <div>
    ...
    <div class="sub">{{ __('CSV : nom, prenom, date_naissance, sexe, telephone, email, adresse, classe, statut, code_massar') }}</div>
  </div>
  <div class="actions">
...
<div class="card" style="max-width:560px">
  <form method="POST" action="{{ route('students.import.store') }}" enctype="multipart/form-data">
    ...
    <p class="muted">{{ __('Mise à jour si matricule (si fourni) ou nom+prénom existent déjà. Séparateur ; ou ,.') }}</p>
