@extends('layouts.app')
@section('title',__('Modifier élève'))
@section('content')
<div class="page-head"><div><h1>{{ __('Modifier —') }} {{ $student->full_name }}</h1></div><a class="btn btn-ghost" href="{{ route('students.index') }}">{{ __('Retour') }}</a></div>
