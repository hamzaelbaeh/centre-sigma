...
<div class="sub">{{ __('Définissez les frais par classe. La mensualité est utilisée par la génération automatique des paiements. Mettre 0 pour supprimer un frais.') }}</div></div></div>
