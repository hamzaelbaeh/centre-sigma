...
<div class="actions"><button class="btn btn-ghost" onclick="window.print()">Imprimer</button><a class="btn btn-ghost" href="#">Excel</a><a class="btn btn-gold" href="{{ route('teachers.create') }}">Nouvel enseignant</a></div></div>
